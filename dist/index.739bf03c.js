...
})({"dP7vO":[function(require,module,exports,__globalThis) {
...
parcelHelpers.export(exports, "ProductDisplay", ()=>ProductDisplay);
...
class ProductDisplay {
    ...
    async fetchContent(searchQuery = "") {
        ...
        if (searchQuery) url += `&fields.color=${searchQuery}`;
        const response = await fetch(url);
        const data = await response.json();
    ...
    async populateColumns1(color) {
        ...
        content.forEach((item, index)=>{
            ...
            else if (index < totalElementInColumn * 2) column2.appendChild(figure2);
  ...
  <a href="./details22.html?title=${item.title}&year=${item.year}&description=${item.description}&imageUrl=${encodeURIComponent(item.imageUrl)}" class="column__item-link" >
...
window.showDetails = function(imageUrl, title, year) {
    alert("1");
    const targetUrl = `./details22.html?title=${title}&year=${year}&imageUrl=${encodeURIComponent(imageUrl)}`;
...
window.selectColor = async function(color) {
    ...
    const selectedColorElement = document.querySelector(`[onclick="selectColor('${color}')"]`);
...
if (window.location.pathname === "/") (0, _utils.preloadImages)(".column__item-img").then(()=>{
...
},{"469e3acfa4a2d33e":"aYzyZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aYzyZ":[function(require,module,exports,__globalThis) {
/*!
 * imagesLoaded v4.1.4
...
},{}],"5bMWt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
class Grid {
   ...
   */ constructor(DOM_el){
        ...
        // console.log(this.DOM.gridItems, "gggg");
        // Assign a ContentItem to each GridItem
        this.DOM.gridItems.forEach((gridItem)=>{
            const newItem = new (0, _gridItem.GridItem)(gridItem);
            //   console.log(newItem, "2222222222");
            this.gridItemArr.push(newItem);
            // The ContentItem instance
            newItem.contentItem = new (0, _contentItem.ContentItem)(this.DOM.contentItems[newItem.position]);
        });
   ...
   * Initialize the Locomotive scroll.
   */ initSmoothScroll() {
        this.lscroll = new (0, _locomotiveScrollDefault.default)({
            el: this.DOM.el,
            smooth: true,
            lerp: 0.13,
            smartphone: {
   ...
   */ initEvents() {
        ...
        window.addEventListener("resize", ()=>{
            ...
            (0, _gsap.gsap).set(this.gridItemArr[this.currentGridItem].DOM.img.outer, {
            ...
            for (const [position, viewportGridItem] of this.viewportGridItems.entries()){
                ...
                (0, _gsap.gsap).set(viewportGridItem.DOM.img.outer, {
   ...
   */ showContent(gridItem) {
        ...
        this.timeline = (0, _gsap.gsap).timeline({
            ...
            x: imageTransform.x,
            y: imageTransform.y,
            onComplete: ()=>(0, _gsap.gsap).set(gridItem.DOM.img.outer, {
                    willChange: ""
                })
        }, "start").to(gridItem.DOM.img.inner, {
            scale: 1,
            ...
            (0, _gsap.gsap).set(this.DOM.contentNavItems, {
                y: `${(0, _gsap.gsap).utils.random(100, 300)}%`,
                opacity: 0
            });
        }, "start");
        for (const [position, viewportGridItem] of this.viewportGridItems.entries()){
            ...
            this.timeline.to([
                ...
                x: this.getFinalTranslationValue(imgOuter, position).x,
                y: this.getFinalTranslationValue(imgOuter, position).y,
                onComplete: ()=>(0, _gsap.gsap).set(imgOuter, {
                        willChange: ""
                    }),
                delay: 0.03 * position
            }, "start");
   ...
   */ closeContent() {
        ...
        (0, _gsap.gsap).timeline({
            ...
            y: 0,
            onComplete: ()=>{
                (0, _gsap.gsap).set(gridItem.DOM.img.outer, {
                    willChange: ""
                });
                (0, _gsap.gsap).set([
                    gridItem.DOM.el,
            ...
            onComplete: ()=>{
                (0, _gsap.gsap).set(this.viewportGridItemsImgOuter, {
                    willChange: ""
                });
            }
   ...
   */ getFinalTranslationValue(gridItemImageOuter, position) {
        const imgrect = (0, _utils.adjustedBoundingRect)(gridItemImageOuter);
        const navrect = (0, _utils.adjustedBoundingRect)(this.DOM.contentNavItems[position]);
        return {
   ...
   */ calcTransformImage() {
        const imgrect = (0, _utils.adjustedBoundingRect)(this.gridItemArr[this.currentGridItem].DOM.img.outer);
        return {
...
},{"./utils":"72Dku","locomotive-scroll":"iDXE3","./gridItem":"csHCv","./contentItem":"3KOIn","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iDXE3":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"csHCv":[function(require,module,exports,__globalThis) {
/**
 * Class representing a grid of items
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3KOIn":[function(require,module,exports,__globalThis) {
/**
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dP7vO","ebWYT"], "ebWYT", "parcelRequire94c2")
